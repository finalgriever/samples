...
public class NoteReminderNotification {
    ...
    public static final String NOTE_REMINDER_CHANNEL = "NoteReminderChannel";
    ...
    public static void notify(final Context context,
        ...
        Intent noteListIntent = new Intent(context, MainActivity.class);
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NOTE_REMINDER_CHANNEL)
                ...
                .setStyle(new NotificationCompat.BigTextStyle().bigText(noteText).setBigContentTitle(noteTitle).setSummaryText("Review note"))
                ...
                .addAction(-1, "View All Notes", PendingIntent.getActivity(context, 0, noteListIntent, PendingIntent.FLAG_UPDATE_CURRENT))
                .addAction(-1, "Backup Notes", PendingIntent.getService(context, 0, backupServiceIntent, PendingIntent.FLAG_UPDATE_CURRENT))
